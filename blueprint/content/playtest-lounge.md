<!--
  Pinned in the playtester channel. Sets expectations once so nobody has to be
  told individually.

  NOTE: this deliberately does NOT say playtest builds are secret. That is a
  decision, not a default, and plenty of developers would rather footage of
  their playtest spread as far as it can. If you want it confidential, say so
  here and add it to content/rules.md as a numbered rule.
-->
