...
Discord's API has no per-member last-active field. There is no way to ask who has gone quiet, and no way to ask later about a week nothing was recording. Any answer to "did people come back after that update" or "did the code drop bring anyone in" has to come from something that was listening at the time.
